...
namespace Shared.Protos {
  public static partial class StatisticsProtoService
  {
    ...
    /// <summary>Base class for server-side implementations of StatisticsProtoService</summary>
    [grpc::BindServiceMethod(typeof(StatisticsProtoService), "BindService")]
    public abstract partial class StatisticsProtoServiceBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::Shared.Protos.GetClicksCountByLinkCodeResponse> GetClicksCountByLinkCode(global::Shared.Protos.GetClicksCountByLinkCodeRequest request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(StatisticsProtoServiceBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          .AddMethod(__Method_GetClicksCountByLinkCode, serviceImpl.GetClicksCountByLinkCode).Build();
    }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, StatisticsProtoServiceBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_GetClicksCountByLinkCode, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Shared.Protos.GetClicksCountByLinkCodeRequest, global::Shared.Protos.GetClicksCountByLinkCodeResponse>(serviceImpl.GetClicksCountByLinkCode));
    }
